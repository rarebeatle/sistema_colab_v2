...
import { EntityArrayResponseType, MedicamentoService } from '../service/medicamento.service';
...
export class MedicamentoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMedicamento): number => this.medicamentoService.getMedicamentoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.medicamentos = this.refineData(dataFromBody);
  }

  protected refineData(data: IMedicamento[]): IMedicamento[] {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.medicamentoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
